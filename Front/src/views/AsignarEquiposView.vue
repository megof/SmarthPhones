...
<h2>Asignar Equipo</h2>
  <n-space vertical>
      ...
      <n-form-item label="Referencia">
        <n-select v-model:value="values" :options="optiones" />
      </n-form-item>
       <n-form-item label="Observacion">
      <n-mention type="textarea"  v-model="form.observacion" />
      </n-form-item>
      <n-form-item>
...
export default({
    components: {
    NSelect,NButton, NForm,NFormItem,NMention
  },
  data() {
    return {
      options: [
